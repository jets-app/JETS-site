      ...
      <section className="relative flex flex-col items-center justify-start min-h-[100dvh]">
        <div className="relative w-full flex flex-col items-center min-h-[100dvh]">
          ...
          <div className="container mx-auto flex flex-col items-center justify-start relative z-10">
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-white/70 font-medium text-center text-sm uppercase tracking-[0.25em]"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h2
                  className="font-serif text-5xl md:text-7xl lg:text-8xl font-semibold text-white transition-none tracking-tight"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className="font-serif text-5xl md:text-7xl lg:text-8xl font-semibold text-center text-white transition-none tracking-tight italic"
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
            ...
            <motion.section
              className="flex flex-col w-full px-8 py-10 md:px-16 lg:py-16"
              initial={{ opacity: 0 }}
