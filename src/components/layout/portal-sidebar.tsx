    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-xl border-b h-14 flex items-center px-4">
        ...
        <div className="flex items-center gap-2 ml-3">
          ...
          <span className="font-semibold text-sm">JETS Portal</span>
        </div>
      </div>
      ...
      >
        {/* Logo */}
        <div className="h-14 lg:h-16 flex items-center px-5 border-b border-sidebar-border">
        ...
        <div className="px-3 pb-4 border-t border-sidebar-border pt-4">
          <form action="/api/auth/signout" method="POST">
            <button
              type="submit"
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-sidebar-foreground/60 hover:bg-sidebar-accent/50 hover:text-sidebar-foreground transition-all duration-200 w-full"
            >
